...
const VideoBlock = ({
        ...
        if (isEmpty || !videoUrl) {
            return (
                <div className={styles.emptyState}>
                    <div className={styles.emptyText}>Generate to see video</div>
                </div>
            );
        }
        ...
        if (hasError) {
            return (
                <div className={styles.errorState}>
                    <div className={styles.errorText}>Failed to load video</div>
                </div>
            );
        }
    ...
    return (
        <div
            className={`${styles.videoBlock} ${isEmpty ? styles.empty : ''} ${
